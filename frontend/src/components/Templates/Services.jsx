...
const Services = ({ serviceType = "renovation" }) => {
  // Get the data for the specified service type
  const currentData = servicesData[serviceType]

  // Fallback if service type doesn't exist
  if (!currentData) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <p className="text-red-500 text-xl">Service type "{serviceType}" not found.</p>
      </div>
    )
  }

  const { hero, services } = currentData
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gray-900 text-white">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:px-6 lg:px-8">
          <div className="md:w-2/3">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">{hero.title}</h1>
            <p className="mt-6 text-xl max-w-3xl">{hero.description}</p>
            <div className="mt-10 flex flex-wrap gap-4">
              <button className="bg-yellow-500 text-gray-900 px-6 py-3 rounded-md font-medium hover:bg-yellow-400 transition-colors">
                Get a Free Quote
              </button>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-900">{services.title}</h2>
            <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">{services.description}</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
              We follow a proven process to ensure your project is completed on time and within budget
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="relative">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md h-full">
                  <div className="lg:ml-4">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Consultation</h3>
                    <p className="text-gray-600">
                      We meet to discuss your vision, requirements, and budget for your project.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md h-full">
                  <div className="lg:ml-4">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Design & Planning</h3>
                    <p className="text-gray-600">Our team creates detailed plans and designs for your project.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md h-full">
                  <div className="lg:ml-4">
                    ...
                    <p className="text-gray-600">
                      Our skilled professionals execute the project with attention to detail and quality.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md h-full">
                  <div className="lg:ml-4">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2">Final Delivery</h3>
                    <p className="text-gray-600">
                      We conduct a thorough review to ensure everything meets our high standards.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="group relative overflow-hidden rounded-lg shadow-md">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-80 transition-opacity duration-300 flex items-end">
                <div className="p-4 text-white">
                  ...
                  <p className="text-sm">Professional service delivery with excellent results</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg shadow-md">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-80 transition-opacity duration-300 flex items-end">
                <div className="p-4 text-white">
                  ...
                  <p className="text-sm">High-quality execution with attention to detail</p>
                </div>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-lg shadow-md">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-0 group-hover:opacity-80 transition-opacity duration-300 flex items-end">
                <div className="p-4 text-white">
                  <h3 className="text-lg font-semibold">Custom Solution</h3>
                  <p className="text-sm">Tailored approach for unique requirements</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 italic mb-4">
                "The team was professional and completed our project on time and within budget. We couldn't be happier
                with the results!"
              </p>
              <div>
                <p className="font-semibold text-gray-900">Sarah Johnson</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 italic mb-4">
                "We've used this service multiple times and have always been impressed with the quality of work and
                attention to detail."
              </p>
              <div>
                <p className="font-semibold text-gray-900">Michael Brown</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
              ...
              <p className="text-gray-700 italic mb-4">
                "Our project exceeded all expectations. The team was professional, clean, and completed the work ahead
                of schedule."
              </p>
              <div>
                <p className="font-semibold text-gray-900">Jennifer Davis</p>
