          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="bg-white overflow-hidden shadow-lg rounded-lg">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900">Kitchen Remodeling</h3>
                  <p className="mt-2 text-gray-600">
                    Complete kitchen renovation with custom cabinets, countertops, and modern appliances.
                  </p>
                  <p className="mt-4 font-medium text-yellow-600">Starting at $15,000</p>
              ...
              <div className="bg-white overflow-hidden shadow-lg rounded-lg">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900">Bathroom Renovation</h3>
                  <p className="mt-2 text-gray-600">
                    Transform your bathroom with new fixtures, tiles, and modern designs.
                  </p>
                  <p className="mt-4 font-medium text-yellow-600">Starting at $8,000</p>
                  <button className="mt-6 w-full bg-gray-800 text-white py-2 px-4 rounded-md hover:bg-gray-700 transition-colors">
                    Learn More
                  </button>
                </div>
              ...
              <div className="bg-white overflow-hidden shadow-lg rounded-lg">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-semibold text-gray-900">Basement Finishing</h3>
                  <p className="mt-2 text-gray-600">
                    Convert your basement into a functional living space, home theater, or gym.
                  </p>
                  <p className="mt-4 font-medium text-yellow-600">Starting at $20,000</p>
                  <button className="mt-6 w-full bg-gray-800 text-white py-2 px-4 rounded-md hover:bg-gray-700 transition-colors">
                    Learn More
                  </button>
                </div>
