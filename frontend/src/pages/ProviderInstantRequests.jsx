        ...
        <div className="flex justify-between items-center">
          ...
          <div className="relative">
            ...
            {showNotifications && notifications.length > 0 && (
              <div className="absolute right-0 w-80 bg-white rounded-md shadow-lg z-10 max-h-96 overflow-y-auto overflow-x-hidden">
                <div className="w-full p-3 border-b border-gray-200 flex justify-between items-center bg-indigo-500 text-white overflow-x-hidden sticky top-0 z-10">
              ...
              <div key={request.id || index} className="bg-white rounded-sm shadow-md p-4 border border-gray-300 overflow-hidden">
                <div className="flex justify-between items-start mb-3">
                  <div className='-mt-2'>
                    ...
                    <h3 className="font-medium -mt-1">Requester Name</h3>
                  </div>
                  <div className="flex items-center space-x-2 -mt-2">
                    <span className="tracking-wide bg-indigo-100 px-2 py-1.5 rounded-bl-sm -mt-3 -mr-4 font-semibold text-indigo-800 text-xs">
                      {offerAttempts[`${request.id}_${request.serviceType}`] > 0
                        ? `${3 - offerAttempts[`${request.id}_${request.serviceType}`]} Left` : "New"}
                    </span>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-full py-2 rounded-sm transition-colors ${(offerAttempts[`${request.id}_${request.serviceType}`] || 0) >= 3
