const RankingCard = ({ position, name, location, imageUrl, metrics }) => {
    return (
      <div className="bg-white rounded-md shadow-sm p-5">
        <div className="md:flex flex-col md:flex-row items-start md:items-center gap-4">
          <p className="absolute px-3 py-1 text-white font-bold bg-primary text-[12px] tracking-wide transform rotate-[-20deg] -mt-5 md:mt-0 md:mb-24 -ml-8 border-2 border-dashed border-white">
            {position} Position
          </p>
